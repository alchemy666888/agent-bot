...
Approval note: The previous approval was invalidated by the reopened persistence requirements. This PostgreSQL handoff must not be used; this file will be rewritten after the replacement `tasks.md` is approved.
